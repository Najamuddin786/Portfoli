    ...
    return <>
        <Flex p='5% 20%' flexDir={'column'}>
            ...
            <Flex   gap={10} justifyContent={'space-between'} flexWrap={'wrap'}>
               {skill.map((e,i)=>{
                return <Flex justifyContent={'center'} align={'center'} flexDir={'column'} w='150px' h='150px' className="rotating-div" cursor={'pointer'}  style={{border:'2px solid #21618c',borderRadius:'150px'}}> <Image w='50px'  src={e.url}/><Text fontSize={'24px'} fontWeight={600} textAlign={'center'}>{e.lable}</Text></Flex>
               })}
            </Flex>
